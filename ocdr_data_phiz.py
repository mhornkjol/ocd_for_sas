...
def compute_ocd_reduced(c0, c1, c_bc, tau, z_height, D, alpha, n, results_dir, boundaries, space="CG", reg="H1"):
    # c0:
    # c1:
    # tau:   time step
...
def map_patient(patient_dir, n, alpha, key, results_dir, use_dti, imfolder):
    ...
    space = "CG"
    reg = "H1"
    (c, phi) = compute_ocd_reduced(c0, c1, c_bc, tau, z_height, D, alpha, n, results_dir, boundaries,
                                   space=space, reg=reg)
