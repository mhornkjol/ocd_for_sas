...
def compute_ocd_reduced(c0, c1, tau, D, alpha, n, results_dir, boundaries, space="CG", reg="H1"):
    ...
    solve(a == L, c, bc, solver_parameters={"linear_solver": "mumps"}, form_compiler_parameters=ffc_options)
...
def run_ocd_reduced(num=None, n=None, beta=None, key=None):
    ...
    dirname = "results_red_ocd_pat%s_n%d_beta%.1e_%s_normalized%s" % (num, n, beta, key, normalized)
